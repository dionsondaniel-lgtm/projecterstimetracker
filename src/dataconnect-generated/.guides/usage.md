...
```ts
import { useCreateUser, useListProjectsForUser, useCreateTimeEntry, useUpdateProject } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateUser(createUserVars);

const { data, isPending, isSuccess, isError, error } = useListProjectsForUser();
...
```js
import { createUser, listProjectsForUser, createTimeEntry, updateProject } from '@dataconnect/generated';


// Operation CreateUser:  For variables, look at type CreateUserVars in ../index.d.ts
const { data } = await CreateUser(dataConnect, createUserVars);

// Operation ListProjectsForUser: 
